...
class More {
    ...
    async fetchMore(options, startIndex = 0, children = {}, nested = false) {
    ...
    async fetchTree(options, startIndex = 0, children = {}, nested = false) {
        throw new exceptions_1.NotImplemented();
        /*
...
exports.emptyChildren = new More({ children: [] });
